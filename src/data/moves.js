...
export function buildNormals(def) {
  ...
  add({
    ...
    startup: S(4), active: 3, recovery: S(7),
  ...
  add({
    ...
    startup: S(5), active: 3, recovery: S(8),
  ...
  add({
    ...
    startup: S(8), active: 4, recovery: S(17),
  ...
  add({
    ...
    startup: S(11), active: 5, recovery: S(21),
    hits: [hit({
  ...
  add({
    ...
    startup: S(7), active: 4, recovery: S(24),
    hits: [hit({
  ...
  add({
    ...
    startup: S(9), active: 4, recovery: S(24),
    hits: [hit({
  ...
  add({
    ...
    startup: S(15), active: 4, recovery: S(20),
    hits: [hit({
  ...
  add({
    ...
    startup: S(12), active: 5, recovery: S(22),
    hits: [hit({
